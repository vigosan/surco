...
// three modes and a hint describing the active one — the underlying adeclick knobs
// (window, AR order, threshold, burst) are deliberately not exposed, the presets
